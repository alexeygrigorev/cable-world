...
- [ ] #66/#67 Follow-up после первого donor-derived pass: grass/meadow patches стали заметнее, но часть из них выглядит отдельными желтыми пятнами; нужно либо приглушить/маскировать края, либо заменить на более органичные land texture glyphs.

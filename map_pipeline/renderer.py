...
EUROPE_BOUNDS = (-10, 35, 30, 60)
IMAGE_SIZE = (1024, 1024)
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), "..", "assets", "map", "europe_base.png")
...
def render():
    proj = MapProjection(EUROPE_BOUNDS, IMAGE_SIZE)

    print("Loading Natural Earth data...")
    land_110 = load_shapefile("ne_110m_land")
    ...
    print("Clipping to Europe bounds...")
    land_110 = clip_to_bounds(land_110, EUROPE_BOUNDS)
    countries = clip_to_bounds(countries, EUROPE_BOUNDS)
    lakes_110 = clip_to_bounds(lakes_110, EUROPE_BOUNDS)
    land_50 = clip_to_bounds(land_50, EUROPE_BOUNDS)

...
ALPINE_MASSIF_SEGMENTS = [
    {
        ...
        "terrain_note": "shape follows the Alpine arc itself; country borders are context only",
        ...
        "glyphs": [
            ...
            ("massif_alps_central_high", 7.08, 46.10, 500, 0.01),
            ("massif_alps_western_arc", 7.78, 46.28, 470, 0.02),
        ],
    },
    {
        ...
        "terrain_note": "central high Alpine wall; not derived from country borders",
        ...
        "glyphs": [
            ...
            ("massif_alps_central_high", 9.20, 46.42, 560, 0.01),
            ("massif_alps_tyrol_wall", 10.00, 46.58, 500, 0.02),
        ],
    },
    {
        ...
        "terrain_note": "northern limestone and Tyrol sector of the same Alpine system",
        ...
        "glyphs": [
            ...
            ("massif_alps_tyrol_wall", 11.42, 46.92, 540, 0.01),
            ("massif_alps_eastern_arc", 12.36, 47.08, 500, 0.02),
        ],
    },
    {
        ...
        "terrain_note": "German Alpine edge as a northern foothill/edge of the Alps, not a separate country-bounded strip",
        ...
        "glyphs": [
            ...
            ("massif_alps_northern_edge", 11.55, 47.64, 365, -0.01),
            ("massif_alps_foothill_connector", 12.44, 47.72, 340, 0.00),
        ],
    },
    {
        ...
        "terrain_note": "eastern continuation of the Alpine arc; country borders are not shape drivers",
        ...
        "glyphs": [
            ...
            ("massif_alps_eastern_arc", 14.08, 47.16, 520, 0.01),
...
RELIEF_REGIONS = [
    ...
    },
    {
        ...
        "points": [
            (5.55, 45.25), (6.65, 45.35), (8.55, 45.60), (10.55, 45.76),
            (12.60, 45.98), (14.50, 46.18), (16.42, 46.45), (16.48, 47.48),
            (14.72, 48.18), (12.20, 48.34), (10.10, 48.10), (8.25, 47.62),
            (6.35, 47.20), (5.52, 46.48),
        ],
